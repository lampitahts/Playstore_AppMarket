...
class DetailTopChart extends StatefulWidget {
  final TopChartModel app;

  const DetailTopChart({Key? key, required this.app}) : super(key: key);

  @override
  _DetailTopChartState createState() => _DetailTopChartState();
}

class _DetailTopChartState extends State<DetailTopChart> {
  List<Review> reviews = [];
                      ...
                      : ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            minimumSize: Size(double.infinity,
                                50), // Menentukan lebar minimum dan tinggi tombol
                          ),
                        ),
                ],
              ),
