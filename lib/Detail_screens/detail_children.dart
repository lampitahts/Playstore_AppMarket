...
class Detailchildren extends StatefulWidget {
  final ChildrenModel app;

  const Detailchildren({Key? key, required this.app}) : super(key: key);

  @override
  _DetailchildrenState createState() => _DetailchildrenState();
}
...
class _DetailchildrenState extends State<Detailchildren> {
  ...
  void _addToInstalled() async {
    ...
    installedApps.add(widget.app.name); 
  ...
  void _removeFromInstalled() async {
    ...
    if (installedApps != null) {
      installedApps.remove(widget.app.name); 
      prefs.setStringList('installApp', installedApps);
    }
  }
}
